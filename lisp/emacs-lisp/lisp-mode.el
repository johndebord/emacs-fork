    ...
    (defconst lisp-el-font-lock-keywords-2
      (append
       ...
       `( ;; Regexp negated char group.
         ...
         ;;; Cleanup.
         ;;;
         ;;; Additional syntax highlighting for `lisp-mode` and
         ;;; `emacs-lisp-mode`: `test`.
         ;; Words inside ‘’, `', and `` tend to be symbol names. ;; jd
         (,(concat "[`‘]\\(\\(?:\\sw\\|\\s_\\|\\\\.\\)"          ;; jd
                   lisp-mode-symbol-regexp "\\)[`'’]")           ;; jd
          (1 font-lock-comment-symbol-face prepend))
         ;; Constant values.
